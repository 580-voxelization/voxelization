...
//    TODO; //fill color with casted ray result;
    ...
    if (hit.object) {
        ...
        color = shader->Shade_Surface(ray, intersection_point, normal, recursion_depth, hit);
    } else {
        color = background_shader->Shade_Surface(ray, vec3(0, 0, 0), vec3(0, 0, 0), recursion_depth, hit);
    }
